...
class DefinitionsApi {
  ...
  const DefinitionsApi(this._dio);
  ...
  Future<Response<void>> v1DefinitionsIdDelete({
    required String id,
    ...
    final _path = r'/v1/definitions/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DefinitionResponse>> v1DefinitionsIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1DefinitionsIdLikeDelete({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/definitions/{id}/like'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1DefinitionsIdLikePut({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersIdFollowersGet200Response>> v1DefinitionsIdLikesGet({
    required String id,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/v1/definitions/{id}/likes'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [DefinitionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DefinitionResponse>> v1DefinitionsIdPatch({
    required String id,
    ...
    try {
      _bodyData = jsonEncode(updateDefinitionRequest);
    } catch (error, stackTrace) {
      throw DioException(
  ...
  /// Returns a [Future] containing a [Response] with a [DefinitionResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DefinitionResponse>> v1DefinitionsPost({
    ...
    try {
      _bodyData = jsonEncode(createDefinitionRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
