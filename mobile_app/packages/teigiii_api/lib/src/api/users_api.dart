...
class UsersApi {
  ...
  Future<Response<Uint8List>> v1AvatarsIdGet({
    required String id,
    ...
    final _path = r'/v1/avatars/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersIdDefinitionsGet200Response>> v1UsersIdDefinitionsGet({
    required String id,
    String? cursor,
    int? limit = 20,
    String? wordId,
    ...
    final _path = r'/v1/users/{id}/definitions'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (wordId != null) r'wordId': wordId,
      if (subGroup != null) r'subGroup': subGroup,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1UsersIdDictionaryGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersIdDictionaryGet200Response>> v1UsersIdDictionaryGet({
    required String id,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/v1/users/{id}/dictionary'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
    ...
    V1UsersIdDictionaryGet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ...
          : deserialize<
              ...
              V1UsersIdDictionaryGet200Response
            >(rawData, 'V1UsersIdDictionaryGet200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1UsersIdDictionaryGet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1UsersIdFollowDelete({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/users/{id}/follow'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1UsersIdFollowPut({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersIdFollowersGet200Response>> v1UsersIdFollowersGet({
    required String id,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/v1/users/{id}/followers'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [V1UsersIdFollowersGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersIdFollowersGet200Response>> v1UsersIdFollowingGet({
    required String id,
    String? cursor,
    int? limit = 20,
    CancelToken? cancelToken,
    ...
    final _path = r'/v1/users/{id}/following'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UserResponse>> v1UsersIdGet({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/users/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future] containing a [Response] with a [V1UsersIdDefinitionsGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersIdDefinitionsGet200Response>>
  v1UsersIdLikedDefinitionsGet({
    ...
    final _path = r'/v1/users/{id}/liked-definitions'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1UsersIdMuteDelete({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/users/{id}/mute'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1UsersIdMutePut({
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1UsersMeAvatarDelete({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/users/me/avatar';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [V1UsersMeAvatarPut200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<V1UsersMeAvatarPut200Response>> v1UsersMeAvatarPut({
    MultipartFile? body,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    V1UsersMeAvatarPut200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawData == null
          ? null
          : deserialize<
              V1UsersMeAvatarPut200Response,
              V1UsersMeAvatarPut200Response
            >(rawData, 'V1UsersMeAvatarPut200Response', growable: true);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<V1UsersMeAvatarPut200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> v1UsersMeDelete({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeResponse>> v1UsersMeGet({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [MeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeResponse>> v1UsersMePatch({
  ...
  /// Returns a [Future] containing a [Response] with a [MeResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeResponse>> v1UsersPost({
