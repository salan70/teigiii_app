...
class DefinitionPostRoute extends PageRouteInfo<DefinitionPostRouteArgs> {
  DefinitionPostRoute({
    ...
    AfterPostNavigationType afterPostNavigation =
        AfterPostNavigationType.toDetail,
    List<PageRouteInfo>? children,
  }) : super(
...
class DefinitionPostRouteArgs {
  ...
  @override
  String toString() {
    return 'DefinitionPostRouteArgs{key: $key, draftId: $draftId, initialDefinitionForWrite: $initialDefinitionForWrite, autoFocusForm: $autoFocusForm, afterPostNavigation: $afterPostNavigation}';
  }
}
