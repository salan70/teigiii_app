...
import 'package:teigi_app/feature/user_follow/repository/user_follow_repository.dart'
    as _i8;
import 'package:teigi_app/feature/user_profile/domain/user_profile.dart' as _i7;
...
class MockUserProfileRepository extends _i1.Mock
  ...
  @override
  _i6.Future<_i3.UserProfileDocument?> searchUserProfileByPublicId(
          String? publicId) =>
      (super.noSuchMethod(
        Invocation.method(
  ...
  @override
  _i6.Future<void> updateUserProfile(_i7.UserProfile? userProfileForWrite) =>
      (super.noSuchMethod(
        Invocation.method(
          #updateUserProfile,
          [userProfileForWrite],
